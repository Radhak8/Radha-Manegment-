...
import RadhaX.modules.sql.global_bans_sql as sql
from RadhaX import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from RadhaX.modules.helper_funcs.misc import send_to_list
from RadhaX.modules.sql.users_sql import get_user_com_chats
