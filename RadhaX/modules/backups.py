...
# from RadhaX.modules.sql import warns_sql as warnssql
import RadhaX.modules.sql.blacklist_sql as blacklistsql

# from RadhaX.modules.sql import cust_filters_sql as filtersql
# import RadhaX.modules.sql.welcome_sql as welcsql
import RadhaX.modules.sql.locks_sql as locksql
import RadhaX.modules.sql.notes_sql as sql

# from RadhaX.modules.rules import get_rules
import RadhaX.modules.sql.rules_sql as rulessql
from RadhaX import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from RadhaX.__main__ import DATA_IMPORT
from RadhaX.modules.connection import connected
from RadhaX.modules.helper_funcs.alternate import typing_action
from RadhaX.modules.helper_funcs.chat_status import user_admin
from RadhaX.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("RadhaX{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("RadhaX{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `RadhaX-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("RadhaX{}.backup".format(chat_id))  # Cleaning file
